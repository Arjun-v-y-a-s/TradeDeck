        ...
        <div className='container p-3'>
            <div className='row p-5'>
                <div className='col-6 p-5'>
                    ...
                    <p className='text-muted'>That's why 1.3+ crore customer trust our service with ₹3.5 lakh crores worth of equity investments </p>
                    ...
                    <h2 className='fs-4'>Our platform</h2>
