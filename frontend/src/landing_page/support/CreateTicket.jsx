    ...
    return (
        <div className='container'>
            <div className='row p-5 mb-5 mt-5'>
                ...
                <div className='col-4 p-3 mb-2 mt-2'>
                    <h4 className=' '>
                    ...
                    <br />
                    <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
                        Charges at TradeDesk
                    </a>
                    <br />
                    <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
                        TradeDesk IDFC FIRST Bank 3-in-1 Account
                    </a>
                    <br />
                    <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
                        Getting Started
                ...
                <div className='col-4 p-3 mb-2 mt-2'>
                    <h4 className=' '>
                       <i class="fa-solid fa-user"></i>  Your STOCK Account
                    </h4>
                    <br />
                    <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
                        Login Credentials
                    ...
                    <br />
                    <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
                        Acount Modification and Segment Addition
                    </a>
                    <br />
                    <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
                ...
                <div className='col-4 p-3 mb-2 mt-2'>
                    <h4 className=' '>
                        <i class="fa-solid fa-people-line"></i> Top Asked
                    </h4>
                    <br />
                    <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
